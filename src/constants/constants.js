export const demoPoints = [
  ...
  {
    imageData:
      'https://cdn.hashnode.com/res/hashnode/image/upload/v1625094452868/Fp-bUmVci.png',
    title: 'Dashboard',
    description: `After you have successfully created an account you will be redirected to your dashboard where you can view all your events created. To create an event click on the Create button on the top right side of the dashboard and you will be redirected to event creation page.`,
  },
  {
    imageData:
  ...
  {
    imageData:
      'https://cdn.hashnode.com/res/hashnode/image/upload/v1625101161718/k8KxQ8PWj.png',
    title: 'Booking Screen',
    description: `After you have shared your link with your invitees on opening the link they will see a booking screen, where all your event dates would be listed, they can book on any date slot if there are available slots and they will be booked for the date.`,
  },
  {
    imageData:
